...
### source : https://github.com/peter3125/sentence2vec/blob/master/sentence2vec.py


import numpy as np
from sklearn.decomposition import PCA
from sklearn.decomposition import TruncatedSVD ##  dan - may be faster alternative for first principle component ?
...
def sentence_to_vec(sentence_list: List[Sentence], embedding_size: int, a: float=1e-3):
    ...
    # pca = PCA() ## orig
    pca = PCA(n_components=1) ## dan - we only need first component
