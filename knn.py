...
#print('Loading UniRef mapping')
#ref2rep_dict = pickle.load(open(f'{DATA_DIR}UniRef2Prot2.pickle', 'rb'))
#print('Loaded')
...
def main():
    ...
    parser.add_argument('--train', 
                        help='Name of file with training vectors (hdf5)')
    parser.add_argument('--targets', default=None, 
                        help='Name of targets file')
    parser.add_argument('-k', '--k', default=1000, type=int, 
                        help='K (nearest neighbors)')
    parser.add_argument('-m', '--model_id', default=None, type=int, 
                        help='Model number for printing')
    parser.add_argument('--annotations', default=False, action='store_true',
                        help='Print annotations, if False, print the neighbors ids. Default is False')
